...
export default function Tour({ tour }) {
  return (
    <div className="group relative flex flex-col justify-between bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300">
      <div className="aspect-[4/3] overflow-hidden bg-gray-200 dark:bg-gray-800 relative">
      ...
      <div className="p-6 flex-1 flex flex-col">
        ...
        <Link 
          ...
          className="w-full text-center py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
        >
          View Details
        </Link>
      </div>
