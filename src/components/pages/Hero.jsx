        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex gap-4">
              ...
              <Link 
                href="/about" 
                className="px-8 py-4 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white font-semibold hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
              >
                Learn More
              </Link>
            </div>
          ...
          <div className="hidden lg:block relative h-[600px] w-full rounded-3xl overflow-hidden border border-gray-200 dark:border-gray-800 shadow-2xl">
            {/* Bento-box style hero images grid */}
            <div className="grid grid-cols-2 gap-4 h-full p-4 bg-gray-50 dark:bg-gray-900">
              <div className="space-y-4">
                <div className="h-2/3 rounded-2xl bg-gray-300 dark:bg-gray-800 overflow-hidden relative">
                ...
                <div className="h-1/3 rounded-2xl bg-gray-300 dark:bg-gray-800 overflow-hidden relative">
