...
export default function CallToAction() {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
      <div className="relative rounded-3xl overflow-hidden px-6 py-20 text-center shadow-2xl sm:px-16 border border-gray-200 bg-white">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <p className="text-xl text-gray-200 mb-10">Join thousands of travelers who have explored the world with our expert-guided tours. Book your next journey today.</p>
