      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/spots" className="text-gray-400 hover:text-white transition-colors">Spots</Link></li>
              <li><Link href="/contact" className="text-gray-400 hover:text-white transition-colors">Contact</Link></li>
              <li><Link href="/verify-ticket" className="text-gray-400 hover:text-white transition-colors">Verify Ticket</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/contact" className="text-gray-400 hover:text-white transition-colors">Cookie Policy</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} {brandName}. All rights reserved. Powered by <Link href={'https://disibin.com'} className="hover:text-white transition-colors">Disibin</Link>.
          </p>
