...
export default function CustomerDashboard() {
  ...
  if (loading) {
    return <div className="animate-pulse flex space-x-4"><div className="flex-1 space-y-6 py-1"><div className="h-2 rounded"></div><div className="space-y-3"><div className="grid grid-cols-3 gap-4"><div className="h-2 rounded col-span-2"></div><div className="h-2 rounded col-span-1"></div></div><div className="h-2 rounded"></div></div></div></div>;
  }
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-3xl border border-gray-200 shadow-sm flex items-center space-x-6">
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-gray-900 mt-1">{data.stats?.total_bookings || 0}</p>
          </div>
        </div>
        <div className="bg-white p-6 rounded-3xl border border-gray-200 shadow-sm flex items-center space-x-6">
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-gray-900 mt-1">${data.stats?.total_spent || 0}</p>
          </div>
        </div>
      </div>
        ...
        <div className="divide-y divide-gray-200">
          {data.upcoming_bookings?.length > 0 ? (
            data.upcoming_bookings.map(booking => (
              <div key={booking.booking_id} className="p-6 transition-colors flex justify-between items-center">
                <div>
