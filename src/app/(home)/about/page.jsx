    ...
    <main className="min-h-screen bg-white dark:bg-gray-900 pt-24 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
          <div className="h-80 rounded-3xl overflow-hidden shadow-lg border border-gray-200 dark:border-gray-800">
          ...
          <div className="h-80 md:mt-12 rounded-3xl overflow-hidden shadow-lg border border-gray-200 dark:border-gray-800">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="mt-8">
              <Link 
                href="/tours" 
                className="inline-block px-8 py-4 rounded-xl text-white font-semibold transition-transform hover:scale-105 shadow-lg"
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-gray-50 dark:bg-gray-900 p-8 rounded-3xl border border-gray-200 dark:border-gray-800 text-center">
              <span className="block text-4xl font-extrabold text-gray-900 dark:text-white mb-2">10+</span>
              <span className="text-gray-600 dark:text-gray-400">Years of Experience</span>
            </div>
            <div className="bg-gray-50 dark:bg-gray-900 p-8 rounded-3xl border border-gray-200 dark:border-gray-800 text-center">
              <span className="block text-4xl font-extrabold text-gray-900 dark:text-white mb-2">50+</span>
              <span className="text-gray-600 dark:text-gray-400">Destinations</span>
            </div>
            <div className="bg-gray-50 dark:bg-gray-900 p-8 rounded-3xl border border-gray-200 dark:border-gray-800 text-center">
              <span className="block text-4xl font-extrabold text-gray-900 dark:text-white mb-2">5k+</span>
              <span className="text-gray-600 dark:text-gray-400">Happy Travelers</span>
            </div>
            <div className="bg-gray-50 dark:bg-gray-900 p-8 rounded-3xl border border-gray-200 dark:border-gray-800 text-center">
              <span className="block text-4xl font-extrabold text-gray-900 dark:text-white mb-2">24/7</span>
