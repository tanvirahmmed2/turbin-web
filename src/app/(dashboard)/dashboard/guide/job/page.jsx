...
export default function GuideJobs() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-white">My Schedule & Jobs</h1>
        <p className="mt-1 text-gray-400">View your assigned upcoming tours and guest manifests.</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {jobs.map((job) => (
          <div key={job.id} className="bg-gray-800 rounded-3xl border border-[#222] overflow-hidden flex flex-col justify-between">
            <div className="p-6">
