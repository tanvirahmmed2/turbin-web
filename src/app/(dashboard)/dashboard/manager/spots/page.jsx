  ...
  return (
    <div className="space-y-8 relative">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-white">Manage Spots</h1>
          <p className="mt-1 text-gray-400">Create and manage your global pool of tour destinations.</p>
        </div>
        <button 
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      {spot.image ? (
                        ...
                        <div className="w-10 h-10 rounded-lg bg-gray-700 mr-4 flex items-center justify-center text-gray-500">
                          No Img
                        </div>
                      )}
                      <div>
                        <div className="text-sm font-bold text-white">{spot.name}</div>
      ...
      {modalOpen && (
        <div className="fixed inset-0 bg-gray-900/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gray-800 rounded-3xl border border-[#222] w-full max-w-lg overflow-hidden shadow-2xl">
            <div className="p-6 border-b border-[#222] flex justify-between items-center">
              <h2 className="text-xl font-bold text-white">{editingSpot ? 'Edit Spot' : 'Create New Spot'}</h2>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-1">Spot Name</label>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
              ...
              <div>
                ...
                <div className="flex items-center space-x-4">
                  {formData.image && (
                    <img src={formData.image} alt="Spot" className="w-16 h-16 rounded-xl object-cover border border-gray-700" />
                  )}
              ...
              <div className="pt-4 flex justify-end gap-3">
                <button
                  type="button"
                  onClick={closeModal}
                  className="px-5 py-2 rounded-xl text-gray-300 font-medium hover:bg-gray-700 transition-colors"
                >
                  Cancel
                </button>
                <button
